...
_start:				      ; Labels the entry point to the program.
	mov       rax, 1              ; rax gets the system call code for "write".
        ...
        mov       rdx, 98             ; rdx gets the number of bytes to write.
...
greetings:			      ; Labels the string of bytes to be written.
	db        "This is my longer message that took me way longer to figure out how to print than it should have!", 10  ; The message, with the byte values for "newline" appended.
; ------------------------------------------------------------------------------
